      ...
      <div className="max-w-2xl text-xs">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-2xs space-y-4">
          ...
          <div>
            ...
            >
              <option value="gemini-3.1-flash-lite">نموذج فلاش لايت الخفيف gemini-3.1-flash-lite (فائق السرعة وخفيف، سعة طلبات عالية ومستقر)</option>
              <option value="gemini-flash-latest">النموذج المتوازن gemini-flash-latest</option>
              <option value="gemini-3.8-flash">نموذج فلاش المتقدم gemini-3.8-flash (دقة تفصيلية)</option>
            </select>
          </div>
